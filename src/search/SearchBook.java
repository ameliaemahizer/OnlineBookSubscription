...
public class SearchBook {
    private SearchBook strategy;

    public void setStrategy(SearchBook strategy) {
        this.strategy = strategy;
    }

    public ArrayList<BookModel> searchBooks(ArrayList<BookModel> books, String query) {
        return SearchBookInterface.search(query, books);
    }

    public ArrayList<BookModel> executeSearch(String query, ArrayList<BookModel> books) {
        if (strategy == null || books == null || query == null) {
